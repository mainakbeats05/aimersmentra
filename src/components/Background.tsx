  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-hero">
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, oklch(0.70 0.18 245 / 0.45), transparent 65%)" }}
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, oklch(0.85 0.14 80 / 0.35), transparent 65%)" }}
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, oklch(0.80 0.14 230 / 0.40), transparent 65%)" }}
      ...
      {Array.from({ length: 18 }).map((_, i) => (
        <motion.span
          ...
          style={{
            left: `${(i * 37) % 100}%`,
            top: `${(i * 53) % 100}%`,
            boxShadow: "0 0 10px oklch(0.52 0.20 255 / 0.5)",
          }}
